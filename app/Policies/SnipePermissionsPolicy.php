...
/**
 * SnipePermissionsPolicy provides methods for handling the granular permissions used throughout Parque Seguro.
...
abstract class SnipePermissionsPolicy
{
    ...
    public function before(User $user, $ability, $item)
    {
         ...
         *
         * @see https://Parque Seguro.readme.io/docs/permissions
         */
