...
class SecurityHeaders
{
	...
	$response->headers->set('Permissions-Policy', "camera=(self 'https://parque-seguro.jf-parquedasnacoes.pt:8126')");

        // Ugh. Feature-Policy is dumb and clumsy and mostly irrelevant for Parque Seguro,
       ...
       // $response->headers->set('Referrer-Policy', config('app.referrer_policy'));
        ...
        // For example, some IT depts have IFRAMED Parque Seguro into their IT portal
        ...
        // people who are not running Parque Seguro over TLS (shame, shame, shame!)
        // Seriously though, please run Parque Seguro over TLS. Let's Encrypt is free.
