        ...
        $layout = [
            ...
            [
                ...
                'title' => ' <span class="hidden-md hidden-lg">Assets</span>'
                    .'<span class="hidden-xs"><i class="fas fa-children fa-lg"></i></span>',
                'visible' => true,
            ],
            [
                ...
                'title' => ' <span class="hidden-md hidden-lg">Licenses</span>'
                    .'<span class="hidden-xs"><i class="fas fa-scroll fa-lg"></i></span>',
                'visible' => true,
            ],
            [
                ...
                'title' => ' <span class="hidden-md hidden-lg">Consumables</span>'
                    .'<span class="hidden-xs"><i class="fas fa-box fa-lg"></i></span>',
                'visible' => true,
            ],
            [
                ...
                'title' => ' <span class="hidden-md hidden-lg">Accessories</span>'
                    .'<span class="hidden-xs"><i class="fas fa-puzzle-piece fa-lg"></i></span>',
                'visible' => true,
            ],
            [
                'field' => 'created_at',
