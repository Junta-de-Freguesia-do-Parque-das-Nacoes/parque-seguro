...
public function responsaveis()
{
  ...
  protected $fillable = [
    ...
    'last_checkin',
    'preference_token',
    '_snipeit_email_de_notificacao_checkinout_52',
    'verification_code',
    'verification_code_expires_at',
    '_snipeit_data_nascimento_34',
    '_snipeit_nif_30',
    '_snipeit_ha_ferias_no_parque_67',
    '_snipeit_utente_sns_29',
    '_snipeit_seg_social_31',
    '_snipeit_morada_no_andar_fracao_lugar_bairro_32',
    '_snipeit_codigo_postal_33',
    '_snipeit_idade_35',
    '_snipeit_data_validade_documento_de_identificacao_37',
    '_snipeit_nomes_irmao_irma_39',
    '_snipeit_tem_algum_problema_de_saude_41',
    '_snipeit_restricoes_alimentares_42',
    '_snipeit_contacto_de_emergencia_47',
    'status',
    'receive_checkin_notifications',
    'receive_checkout_notifications',
    'receive_self_notifications',
    '_snipeit_contacto_telefonico_54',
    '_snipeit_email_55',
    '_snipeit_autoriza_a_recolha_e_difusao_de_imagens_56',
    '_snipeit_grau_de_ensino_57',
    '_snipeit_ano_esc_58',
    '_snipeit_turma_59',
    '_snipeit_tem_irmaos_na_caf_60',
    '_snipeit_concelho_74',
    '_snipeit_distrito_61',
    '_snipeit_freguesia_62',
    '_snipeit_localidade_75',
    '_snipeit_autorizacao_a_recolha_e_difusao_de_imagen_63',
    '_snipeit_pode_sair_sozinho_66',
     ...
     */
     ...
     public function notasEe()
     {
         return $this->hasMany(NotaEe::class, 'asset_id');
     }
    ...
    public function getImageUrl()
{
    if ($this->image && !empty($this->image)) {
        // Usar a rota protegida para imagens
        return route('assets.foto', ['filename' => $this->image]);
    } elseif ($this->model && !empty($this->model->image)) {
        // Usar a rota protegida para modelos
        return route('assets.foto', ['filename' => $this->model->image]);
    }
  ...
  */
    ...
    */
	...
	protected static function boot()
    {
        ...
        // Evento disparado ao criar um novo registro
        static::creating(function ($asset) {
            // Gera o token se ele ainda não existir
            $asset->preference_token = $asset->preference_token ?? Str::random(32);
        });

        // Evento disparado ao atualizar um registro
        static::updating(function ($asset) {
            // Gera o token se ele ainda não existir
            if (!$asset->preference_token) {
                $asset->preference_token = Str::random(32);
            }
        });
    }
