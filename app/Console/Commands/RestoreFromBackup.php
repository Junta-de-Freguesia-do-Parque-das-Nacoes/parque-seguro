...
class RestoreFromBackup extends Command
{
     ...
     * @var string
     */
    protected $description = 'Restore from a previously created Parque Seguro backup file';
    ...
    public function handle()
    {
        ...
        if (strpos($sqlfiles[0], 'db-dumps') === false) {
            ...
            //older Parque Seguro installs don't have the db-dumps subdirectory component
        }
