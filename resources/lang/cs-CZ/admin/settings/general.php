...
'ldap_location_help'             => 'Pole Ldap lokace by se mělo použít, pokud <strong>se v základní linii nepoužívá.</strong> Ponechte prázdné, pokud se používá vyhledávání.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Pokud je zde uvedena adresa URL, uživatelé budou po odhlášení ze Parque Seguro přesměrování na tuto URL. To je užitečné pro správné ukončení relací Authentication providera.',
    ...
    'show_images_in_email_help'   => 'Zrušte zaškrtnutí této kolonky, pokud je instalace Parque Seguro za VPN nebo uzavřenou sítí a uživatelé mimo síť nebudou moci do svých e-mailů načíst obrázky z této instalace.',
    ...
    'snipe_version'  			=> 'Verze Parque Seguro',
    'support_footer'            => 'Odkazy v zápatí na podporu ',
    'support_footer_help'       => 'Určete, kdo uvidí odkazy na Parque Seguro podporu a uživatelskou příručku',
    'version_footer'            => 'Verze v zápatí ',
    'version_footer_help'       => 'Určete kdo uvidí verzi Parque Seguro a číslo sestavení.',
    ...
    'width_w'        => 'š',
    'height_h'        => 'v',
    'show_url_in_emails'                => 'Odkaz na Parque Seguro v e-mailech',
    'show_url_in_emails_help_text'      => 'Zrušte zaškrtnutí tohoto políčka, pokud nechcete odkazovat zpět na instalaci Parque Seguro do vašich emailových patek. Užitečné, pokud se většina vašich uživatelů nikdy nepřihlásí.',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'Toto se pokusí odstranit čárové kódy v mezipaměti. Obvykle se používá v případě, kdy došlo ke změně nastavení čárového kódu nebo v případě, že se změnila URL adresa Parque Seguro. Kódy budou vygenerovány znovu.',
