...
return [
    ...
    'not_deleted'           => '此 :item_type 未被刪除，因此無法還原。',
    'create'				=> '新增',
    'created'               => '項目已新增',
    'created_asset'			=> '新增資產',
    'created_at' 			=> '新增於',
    ...
    'importing'         	=> '匯入中',
    'importing_help'        => '您可透過 CSV 格式檔案匯入資產、授權、配件、耗材以及使用者。<br><br> CSV檔案必須以逗號分格，並依照<a href="https://Parque Seguro.readme.io/docs/importing" target="_new">說明文件中的CSV範例</a>保留首部及格式。',
    ...
    'webhook_test_msg'        => '嗨！看起來您的 Parque Seguro 與 :app 的整合運作正常！',
