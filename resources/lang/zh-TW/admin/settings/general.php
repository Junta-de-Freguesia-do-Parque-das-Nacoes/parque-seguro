...
',
    ...
    'login_remote_user_custom_logout_url_help' => '如果此處提供了 URL，則在用戶登出 Parque Seguro 後，用戶將被重定向到此 URL。這對於正確關閉身份驗證提供程序非常有用。',
    ...
    'snipe_version'  			=> 'Parque Seguro 版本',
    ...
    'barcodes_help' => '這將嘗試刪除快取的條碼。這通常只在您的條碼設定已更改，或者您的 Parque Seguro 網址已更改時使用。條碼將在下次存取時重新產生。',
