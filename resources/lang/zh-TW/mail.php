...
return [
    ...
    'login' => '登入',
    'login_first_admin' => '使用以下憑證登入新安裝的 Parque Seguro：',
    ...
    'supplier' => '供應商',
    'tag' => '標籤',
    'test_email' => 'Parque Seguro 測試電子郵件',
    'test_mail_text' => '這是一封 Parque Seguro 資產管理系統的測試電子郵件，如果您收到，表示郵件通知正常運作 :)',
    ...
    'welcome_to' => '歡迎來到 :web！',
    'your_assets' => '查看您的資產',
    'your_credentials' => '您的 Parque Seguro 憑證',
