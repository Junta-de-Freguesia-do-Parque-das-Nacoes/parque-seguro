...
'ldap_location_help'             => '如果<strong>在 Base Bind DN 中没有使用OU</strong>，则LDAP 位置字段应当被使用；如果正在使用OU Search，请将此项留空。',
    ...
    'help_default_will_use' => '<code>:default</code> 将使用 <code>:setting_name</code>的值。 <br>请注意，条码的值必须符合相应的条码规范才能成功生成。请参阅 <a href="https://Parque Seguro.readme.io/docs/barcodes">文档 <i class="fa fa-external-link"></i></a> 了解更多详细信息。 ',
    'default'               => '默认',
    'none'                  => '无',
