...
return [
    ...
    'importing'         	=> 'Importing',
    'importing_help'        => 'You can import assets, accessories, licenses, components, consumables, and users via CSV file. <br><br>The CSV should be comma-delimited and formatted with headers that match the ones in the <a href="https://Parque Seguro.readme.io/docs/importing" target="_new">sample CSVs in the documentation</a>.',
    ...
    'webhook_test_msg'        => 'Oh hai! It looks like your :app integration with Parque Seguro is working!',
