...
return [
    ...
    'alerts_enabled'			=> 'Alertas utentes',
    ...
    'asset_ids'					=> 'IDs dos Utentes',
    'audit_interval'            => 'Intervalo de revisão de inscrição',
    'audit_interval_help'       => 'Se for obrigado a fiscalizar fisicamente os seus utentes, insira o intervalo em meses que usa. Se você atualizar este valor, todas as "próximas datas de revisão de inscrição" para os utentes com uma data de revisão de inscrição futura serão atualizadas.',
    'audit_warning_days'        => 'Limiar de aviso de revisão de inscrição',
    'audit_warning_days_help'   => 'Quantos dias de antecedência devemos avisar quando os utentes são devidos para a revisão de inscrição?',
    'auto_increment_assets'		=> 'Gerar etiquetas de utentes com incremento automático',
    'auto_increment_prefix'		=> 'Prefixo (opcional)',
    'auto_incrementing_help'    => 'Permitir o incremento automático de etiquetas de utentes antes de configurar isto',
    ...
    'default_eula_help_text'	=> 'Também pode associar EULAs personalizados para categorias de utentes especificas.',
    'acceptance_note'           => 'Insira uma nota (caso julgue necessário)',
    'display_asset_name'        => 'Mostrar Nome do Utente',
    ...
    'general_settings_keywords' => 'suporte à escola, assinatura, aceitação, formato de e-mail, formato de nome de utilizador, imagens, por página, miniatura, gravatar, por, painel, privacidade',
    ...
    'label_logo_size'           => 'Logos quadrados ficam melhor - serão exibidos no topo à direita de cada rótulo de utente. ',
...
'ldap_location_help'             => 'O campo Ldap de localização deverá ser usado se <strong>uma OU não estiver a ser usada na "Base Bind DN".</strong> Deixe em branco se uma pesquisa por OU estiver a ser usada.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Se preenchido, os utilizadores serão redirecionados para este URL depois de fecharem a sessão no SnipeIT. É particularmente útil para fechar corretamente a sessão do utilizador do colaborador de autenticação.',
    ...
    'logo_print_assets_help'    => 'Usar a marca na impressão de lista de utentes ',
    'full_multiple_companies_support_help_text' => 'Restringir utilizadores (incluindo admins) associados a escolas ao utentes da escola.',
    'full_multiple_companies_support_text' => 'Suporte multi-escola completo',
    'show_in_model_list'   => 'Mostrar modelos de utente em menu de cascata',
    'optional'					=> 'opcional',
    ...
    'pwd_secure_uncommon_help'  => 'Isso impedirá os utilizadores de usar senhas comuns das 10 senhas superiores registradas em brechas.',
    ...
    'show_archived_in_list'     => 'Utentes arquivados',
    'show_archived_in_list_text'     => 'Mostrar utentes arquivados na lista "todos os utentes"',
    'show_assigned_assets'      => 'Mostrar utentes atribuídos a utentes',
    'show_assigned_assets_help' => 'Mostrar utentes atribuídos a outros utentes em Ver Utilizador -> Utentes, Mostrar Utilizador -> Informação -> Imprimir Todos Atribuídos e em Conta -> Ver Utentes Atribuídos.',
    'show_images_in_email'     => 'Mostrar imagens em e-mails',
    'show_images_in_email_help'   => 'Desmarque esta caixa se a sua instalação do Parque Seguro estiver a correr através de uma VPN ou rede fechada e utilizadores fora da rede não conseguirem carregar as imagens desta instalação nos seus e-mails.',
    ...
    'snipe_version'  			=> 'Versão Parque Seguro',
    'support_footer'            => 'Links de rodapé de suporte',
    'support_footer_help'       => 'Especifica quem vê os links de Suporte e Manual de utilizador do Parque Seguro',
    ...
    'width_w'        => 'w',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Link para Parque Seguro em E-mails',
    'show_url_in_emails_help_text'      => 'Desmarque esta caixa se não deseja vincular novamente a sua instalação Parque Seguro em seus rodapés de e-mail. Útil se a maioria de seus utilizadores nunca logar.',
    'text_pt'        => 'pt',
    ...
    'two_factor_reset_help'        => 'Isso forçará o utilizador a registar o dispositivo com seu aplicativo de autenticação novamente. Isso pode ser útil se seu dispositivo de matrícula for perdido ou roubado. ',
    ...
    'require_accept_signature_help_text'      => 'Habilitar este recurso vai exigir que os utilizadores assinar fisicamente aceitando o utente.',
    'left'        => 'esquerda',
    'right'        => 'direita',
    'top'        => 'topo',
    'bottom'        => 'fundo',
    ...
    'zerofill_count'        => 'Comprimento de tags de utentes, incluindo zerofill',
    ...
    'no_scopes' => 'No scopes',
    'asset_tag_title' => 'Atualizar configurações de Etiquetas de Utente',
    ...
    'barcodes_help' => 'Isto irá apagar códigos de barras em cache. Isto normalmente só deveria ser usado se as configurações do código de barras tivessem sido alteradas, ou se a URL do Parque Seguro tivesse sido alterada. Códigos de barras serão novamente gerados quando forem acedidos.',
    ...
    'notifications_help' => 'Alertas de e-mail e configurações de revisão de inscrição',
    ...
    'label2_template'         => 'Modelo de Utente',
    'label2_template_help'    => 'Selecione qual modelo de utente a usar para a geração de etiquetas',
    'label2_title'            => 'Título',
    'label2_title_help'       => 'O título a mostrar nas etiquetas que o suportam',
    'label2_title_help_phold' => 'O espaço <code>{COMPANY}</code> será substituído pelo nome do utente&apos;s da escola',
    'label2_asset_logo'       => 'Usar Logo do Utente',
    'label2_asset_logo_help'  => 'Use o logotipo do equipamento atribuído à escola, em vez do valor em <code>:setting_name</code>',
