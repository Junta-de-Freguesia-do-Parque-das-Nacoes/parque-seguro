...
return array(
    ...
    'checkin_email'                     => 'Enviar email para o EE na inscrição / anulação.',
    'checkin_email_notification'        => 'O EE do utente receberá um email da inscrição / anulação.',
    ...
    'eula_text_help'					=> 'Este atributo permite-lhe personalizar os seus EULAs para tipos específicos de utentes. Se apenas tem um para todos os seus utentes, pode selecionar a caixa abaixo, para usar o EULA padrão.',
    'name'                              => 'Nome da Categoria',
    'require_acceptance'				=> 'Solicitar aos utilizadores que confirmem a aceitação de utentes nesta categoria.',
    'required_acceptance'				=> 'Será enviado um email ao utilizador com um link para confirmar a aceitação deste item.',
    'required_eula'						=> 'O EE deste utente receberá um e-mail com uma cópia do regulamento.',
