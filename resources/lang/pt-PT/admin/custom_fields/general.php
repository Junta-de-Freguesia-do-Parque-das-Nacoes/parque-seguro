...
return [
    ...
    'about_fieldsets_text'		=> 'Conjuntos de campos permitem criar grupos de campos personalizados que são frequentemente reutilizados para modelos de utente de utentes específicos.',
...
',
    'required'   		          => 'Requerido',
    'req'   		              => 'Req.',
    'used_by_models'   		    => 'Usado por modelos de utente',
    'order'   		            => 'Ordem',
    ...
    'help_text_description' => 'Este é um texto opcional que irá aparecer abaixo dos elementos de formulário ao editar um utente para fornecer o contexto no campo.',
    'about_custom_fields_title' => 'Sobre os campos personalizados',
    'about_custom_fields_text' => 'Campos personalizados permitem-lhe adicionar atributos arbitrários aos utentes.',
    ...
    'is_unique' => 'Este valor deve ser único em todos os utentes',
    'unique' => 'Único',
    'display_in_user_view' => 'Permitir que o utilizador veja estes valores na sua página de Ver Utentes Atribuídos',
    ...
    'show_in_requestable_list' => 'Mostrar valor na lista de utentes solicitáveis. Campos criptografados não serão exibidos',
