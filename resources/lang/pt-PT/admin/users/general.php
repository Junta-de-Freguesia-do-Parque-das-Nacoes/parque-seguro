...
return [
    ...
    'assets_user'       => 'Utentes alocados a :name',
    'bulk_update_warn'	=> 'Você está prestes a editar as propriedades de: user_count users. Observe que você não pode alterar seus próprios atributos do utilizador usando este formulário e deve fazer edições para seu próprio utilizador individualmente.',
    'bulk_update_help'	=> 'Este formulário permite que você atualize vários utilizadores de uma só vez. Apenas preencha os campos que você precisa alterar. Todos os campos deixados em branco permanecerão inalterados.',
    'current_assets'    => 'Utentes atribuidos atualmente a este utilizador',
    ...
    'print_assigned'    => 'Gerar documento em PDF com todos os itens atribuídos',
    'email_assigned'    => 'Enviar lista de itens atribuídos ao utilizador por email',
    'user_notified'     => 'Um utilizador recebeu um endereço eletrónico com uma lista dos seus itens atualmente atribuídos.',
    'auto_assign_label' => 'Inclua este utilizador quando atribuir inscrições elegíveis automaticamente',
    'auto_assign_help'  => 'Ignorar este utilizador na atribuição automática de inscrições',
    'software_user'     => 'Software Entregue a :name',
    'send_email_help'   => 'Você deve fornecer um endereço de e-mail para este utilizador para enviar-lhe credenciais. Credenciais via e-mail só podem ser feitas na criação do utilizador. As senhas são armazenadas em hash e não podem ser recuperadas depois de salvas.',
    ...
    'update_user_assets_status' => 'Atualizar todos os utentes para esses utilizadores com este estado',
