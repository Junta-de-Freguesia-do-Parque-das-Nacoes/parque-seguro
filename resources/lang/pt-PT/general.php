...
return [
    '2FA_reset'             => '2FA reset',
    'accessories'			=> 'Recursos Educativos e Brinquedos',
    'activated'			    => 'Activado',
    'accepted_date'         => 'Data da Aceitação',
    'accessory'				=> 'Recurso educativo e brinquedo',
    'accessory_report'		=> 'Relatório de Recurso educativo e brinquedo',
    'action'                => 'Ação',
    'activity_report'		=> 'Relatório de atividades',
    'address'				=> 'Morada',
    'admin'					=> 'Administração',
    'admin_tooltip'			=> 'Este utilizador tem privilégios de administrador',
    'superuser'				=> 'Superusuário',
    'superuser_tooltip'		=> 'Este utilizador tem privilégios de superusuário',
    'administrator'			=> 'Administrador',
    'add_seats'             => 'Utilizadores adicionados',
    'age'                   => "Idade",
    'all_assets'			=> 'Todos os Utentes',
    'all'       			=> 'Todos',
    'archived'              => 'Arquivado',
    'asset_models'			=> 'Modelos de Utente de Utente',
    'asset_model'			=> 'Modelo de Utente',
    'asset'					=> 'Utente',
    'asset_report'          => 'Relatório de Utente',
    'asset_tag'				=> 'Etiqueta de Utente',
    'asset_tags'            => 'Etiquetas de Utente',
    'assets_available'		=> 'Utentes Disponíveis',
    'accept_assets'         => 'Utentes Aceites :name',
    'accept_assets_menu'    => 'Utentes Aceites',
    'audit'				    => 'Revisão de Inscrição',
    'audit_report'			=> 'Registro de revisão de inscrição',
    'assets'				=> 'Utentes',
    'assets_audited'        => 'utentes auditados',
    'assets_checked_in_count'     => 'utentes recebidos',
    'assets_checked_out_count'     => 'utentes entregues',
    'asset_deleted_warning'     => 'Este utente foi deletado. Você deve restaurá-lo antes de poder atribuí-lo a alguém.',
    ...
    'bulkaudit'             => 'Revisão de Inscrição em massa',
    'bulkaudit_status'      => 'Status da revisão de inscrição',
    ...
    'byod'                  => 'Validação RGPD',
    'byod_help'             => 'Este campo destina-se a confirmar que o Encarregado de Educação deu a sua autorização para o tratamento dos dados pessoais do aluno, conforme o Regulamento Geral sobre a Proteção de Dados (RGPD). Certifique-se de que o documento de consentimento foi devidamente assinado e arquivado antes de validar este campo.',
    'bystatus'              => 'por Estado',
    'cancel'  				=> 'Cancelar',
    ...
    'companies'			    => 'Escolas/Programas',
    'company'				=> 'Escola/Programa',
    ...
    'create'				=> 'Criar Novo',
    'created'               => 'Utente criado',
    'created_asset'			=> 'utente criado',
    ...
    'custom_report'         => 'Relatório de Utente personalizado',
    'dashboard'				=> 'Dashboard',
    'days'      			=> 'dias',
    'days_to_next_audit'    => 'Dias para próxima revisão de inscrição',
    'date'					=> 'Data',
    ...
    'error'				    => 'Erro',
    'exclude_archived'      => 'Excluir Utentes Arquivados',
    'exclude_deleted'       => 'Excluir utentes apagados',
    'example'				=> 'Exemplo: ',
    ...
    'include_deleted'       => 'Incluir Utentes Excluídos',
    ...
    'importing_help'        => 'Você pode importar ativoss, recursos educativos e brinquedos, inscrições, componentes, materiais de consumo e utilizadores via ficheiro CSV. <br><br>O CSV deve ser delimitado por vírgula e formatado com cabeçalhos que correspondem aos dos <a href="https://Parque Seguro.readme.io/docs/importing" target="_new">CSVs de exemplo na documentação</a>.',
    'import-history'        => 'Histórico de Importação',
    'asset_maintenance'        => 'Incidente de Utente',
    'asset_maintenance_report' => 'Relatório de Incidente de Utentes',
    'asset_maintenances'       => 'Incidentes de Utentes',
    'item'  				=> 'Item',
    ...
    'last_name'             => 'Apelido',
    'license'				=> 'Inscrição',
    'license_report'        => 'Relatório de Inscrições',
    'licenses_available'	=> 'Inscrições disponíveis',
    'licenses'				=> 'Inscrições',
    ...
    'location'              => 'Localização de utilizadores',
    'location_plural'        => 'Localizações',
    'locations'				=> 'Localizações de utilizadores',
    ...
    'maintenances'          => 'Incidentes',
    'manage_api_keys'       => 'Gerir API Keys',
    'manufacturer'			=> 'Agrupamento',
    'manufacturers'			=> 'Agrupamento',
    ...
    'model_no'				=> 'Modelo de Utente Nº.',
    'months'				=> 'meses',
    'moreinfo'				=> 'Mais informação',
    'name'					=> 'Nome',
    'new_password'          => 'Nova senha',
    'next'					=> 'Próximo',
    'next_audit_date'		=> 'Próxima Data Revisão de Inscrição',
    'next_audit_date_help'  => 'A Próxima Data Revisão de Inscrição pode ser usada como um lembrete para a próxima revisão da inscrição do utente nas atividades AAAF ou CAF. Assim, poderias verificar se a criança ainda está inscrita corretamente, se é necessário renovar a inscrição, ou se há atualizações necessárias nos dados do utente.',
    'audit_images_help'     => 'You can find audit images in the utente\'s history tab.',
    'no_email'              => 'Nenhum endereço de e-mail associado a este utilizador',
    'last_audit'		    => 'Última revisão de inscrição',
    'new'					=> 'novo!',
    'no_depreciation'		=> 'Sem Depreciação',
    'no_results'			=> 'Sem Resultados.',
    'no'  					=> 'Não',
    'notes'  				=> 'Notas',
    'order_number'          => 'Número da inscrição/matricula',
    'only_deleted'          => 'Apenas Utentes Excluídos',
    ...
    'remaining'             => 'Restantes',
    'remove_company'        => 'Remover associação de escola',
    'reports'				=> 'Relatórios',
    'restored'				=> 'restaurado',
    'restore'				=> 'Restaurar',
    'requestable_models'    => 'Modelos de Utente Solicitados',
    'requestable_items'     => 'Itens Requisitáveis',
    'requested'				=> 'Solicitado',
    'requested_date'        => 'Data de solicitação',
    'requested_assets'      => 'Utentes solicitados',
    'requested_assets_menu' => 'Utentes solicitados',
    ...
    'select_manufacturer'	=> 'Selecione um Agrupamento',
    'select_model'			=> 'Selecione um Modelo de Utente',
    'select_supplier'		=> 'Selecione um Colaborador',
    'select_user'			=> 'Selecione um Utilizador',
    'select_date'			=> 'Selecione a Data (AAAA-MM-DD)',
    'select_statuslabel'	=> 'Selecionar Estado',
    'select_company'    	=> 'Selecione a escola',
    'select_asset'    		=> 'Selecionar utente',
    ...
    'webhook_test_msg'        => 'Ah, hai! Parece que a sua integração com o Parque Seguro está a funcionar!',
    ...
    'status'    			=> 'Estado',
    'accept_eula'           => 'Contrato de inscrição',
    ...
    'total_assets'			=> 'utentes',
    'total_licenses'		=> 'inscrições',
    'total_accessories'		=> 'recursos educativos e brinquedos totais',
    'total_consumables'		=> 'materiais de consumo totais',
    'type'  				=> 'Tipo',
    ...
    'unaccepted_asset_report' => 'Utentes recusados',
    'users'                 => 'Utilizadores',
    'viewall'				=> 'Ver todos',
    'viewassets'  			=> 'Ver Utentes Alocados',
    'viewassetsfor'         => 'Ver Utentes para :name',
    'website'               => 'Website',
    ...
    'audit_due'             => 'Marcado para Revisão de Inscrição',
    'audit_due_days'        => 'Atributos devidos para revisão de inscrição dentro de :days Dias|Utentes devido para revisão de inscrição dentro de :days',
    'checkin_due'           => 'Vencimento para o checkin',
    'checkin_overdue'       => 'Atrasado por check-in',
    'checkin_due_days'      => 'Utentes devidos para o check-in dentro de :days Dia| Utentes devido para check-in dentro de :days Dias',
    'audit_overdue'         => 'Atrasado para Revisão de Inscrição',
    'accept'                => 'Aceitar :utente',
    'i_accept'              => 'Aceito',
    'i_decline'             => 'Eu recuso',
    'accept_decline'        => 'Aceitar/Recusar',
    'sign_tos'              => 'Assine abaixo para indicar que concorda com os termos do serviço:',
    ...
    'reminder_checked_out_items' => 'Este é um lembrete dos itens atualmente entregues a si. Se pensa que esta lista está incorreta (falta algo, ou aparece aqui algo que nunca recebeu), por favor envie um ticket helpdesk para intranet. Através do link https://intranet.jf-parquedasnacoes.pt:8110/projects/helpdesk/issues/new',
    'changed'               => 'Modificado',
    'to'                    => 'Para',
    'report_fields_info'    => '<p>Selecione os campos que deseja incluir no seu relatório personalizado e clique em Gerar. O arquivo (custom-utente-report-YYYY-mm-dd.csv) será transferido automaticamente e poderá abri-lo no Excel.</p>
            <p>Se quiser exportar apenas alguns utentes, use as opções abaixo para ajustar os seus resultados.</p>',
    'range'                 => 'Intervalo',
    ...
    'dashboard_empty'       => 'Parece que não adicionou nada, então não temos nada incrível para exibir. Comece a adicionar alguns utentes, recursos educativos e brinquedos, materiais de consumo ou inscrições agora!',
    'new_asset'             => 'Novo Utente',
    'new_license'           => 'Nova Inscrição',
    'new_accessory'         => 'Novo Recurso educativo e brinquedo',
    'new_consumable'        => 'Novo Material de consumo',
    'collapse'              => 'Esconder',
    'assigned'              => 'Atribuir',
    'asset_count'           => 'Contagem de Utentes',
    'accessories_count'     => 'Contagem de Recursos Educativos e Brinquedos',
    'consumables_count'     => 'Contagem de Materiais de Consumo',
    'components_count'      => 'Contagem de componentes',
    'licenses_count'        => 'Contagem de inscrições',
    ...
    'asset_information'     => 'Informação do Utente',
    'model_name'            => 'Nome do modelo de utente',
    'asset_name'            => 'Nome do Utente',
    'consumable_information' => 'Informações do Material de consumo:',
    'consumable_name'       => 'Nome do Material de consumo:',
    'accessory_information' => 'Informações sobre recurso educativo e brinquedo:',
    ...
    'checkout_user_tooltip' => 'Rececione este utente para um utilizador',
    'checkin_to_diff_location' => 'Pode optar por verificar este utente em um local diferente da localização padrão deste utente de :default_location se estiver definido',
    ...
    'shitty_browser'        => 'Nenhuma assinatura detetada. Se estiver a usar um navegador mais antigo, por favor use um navegador mais moderno para concluir a sua aceitação de utentes.',
    'bulk_soft_delete'      =>'Também exclua esses utilizadores. O seu histórico de utentes permanecerá intacto a menos que / até que purgue os registos apagados nas configurações do Administrador.',
    ...
    'set_to_null'           => 'Apagar valores para este utente|Apagar valores para todos os :asset_count utentes ',
    ...
    'na_no_purchase_date'   => 'N/D - Nenhuma Data da inscrição fornecida',
    'assets_by_status'      => 'Utentes por Estado',
    'assets_by_status_type'      => 'Utentes por Tipo de Estado',
    'pie_chart_type'        => 'Painel Tipo Gráfico "Pie"',
    'hello_name'            => 'Olá, :name!',
    'unaccepted_profile_warning'   => 'Tem :count utentes que requerem aceitação. Clique aqui para aceitar ou recusá-los',
    ...
    'merge_information' =>  'Isso irá unir os :count utilizadores num único utilizador. Selecione o utilizador que deseja unir abaixo e os utentes, inscrições, etc. serão movidos para o utilizador selecionado e os outros utilizadores serão marcados como apagados.',
    ...
    'auto_incrementing_asset_tags_disabled_so_tags_required' => 'Gestão de auto incremento de etiquetas de conteúdo está desabilitado, assim todas as linhas precisam de ter a coluna "Etiqueta de Utente" preenchida.',
    'auto_incrementing_asset_tags_enabled_so_now_assets_will_be_created' => 'Nota: Gestão de auto incremento de etiquetas de conteúdo está habilitado assim serão criadas \\"Etiquetas de utente\\" para os utentes que não a possuem. As linhas que possuem "Etiqueta de utente" preenchidas, serão atualizadas com as informações fornecidas.',
    ...
    'cancel_request'            => 'Cancelar solicitação deste utente',
    ...
    'confirm' => 'Confirmar',
    'autoassign_licenses' => 'Atribuir inscrições automaticamente',
    'autoassign_licenses_help' => 'Permitir que este utilizador tenha inscrições atribuídas através da ‘interface’ de utilizador ou ferramentas de inscrição de atribuição direta.',
    'autoassign_licenses_help_long' => 'Isto permite que um utilizador possa ter inscrições atribuídas através da interface de inscrições ou por ferramentas de linhs de comando. (Por exemplo, você pode não querer que colaboradores tenham uma inscrição que atribuiria apenas para membros da sua equipe. Pode ainda atribuir inscrições individualmente para esses utilizadores, mas eles não serão incluídos na Inscrição de Entrega para as funções de todos os utilizadores.)',
    'no_autoassign_licenses_help' => 'Não inclua o utilizador para atribuição em massa através da interface do utilizador da inscrição ou das ferramentas do CLI.',
    'modal_confirm_generic'      => 'Tem a certeza?',
    'cannot_be_deleted'      => 'Este utente não pode ser apagado',
    ...
    'error_user_company' => 'A escola alvo de check-out e a escola de utentes não coincidem',
    'error_user_company_accept_view' => 'Um Utente atribuído a você pertence a uma escola diferente, por isso você não pode aceitá-lo nem negá-lo, por favor verifique com o seu gerente',
    'importer' => [
        ...
        'checked_out_to_tag' => 'Entregue a: Etiqueta de Utente',
    ...
    'copied' => 'Copiado!',
    'status_compatibility' => 'Se os utentes já estão atribuídos, eles não podem ser alterados para um tipo de status não implantável e este valor será ignorado.',
    'rtd_location_help' => 'Esta é a localização do utente quando ele não está checado',
    ...
    'permission_denied_superuser_demo' => 'Permissão negada. Você não pode atualizar informações de utilizador para superadministradores na demonstração.',
    'pwd_reset_not_sent' => 'Utilizador não está ativado, está sincronizado com o LDAP ou não tem um endereço de e-mail',
    'error_sending_email' => 'Erro ao enviar email',
    'sad_panda' => 'Que pena. Não tem autorização para realizar esta ação.',
    'bulk' => [
            'delete' =>
                [
    ...
    'no_requestable' => 'Não há utentes solicitáveis ou modelos de utente de utentes.',

    'countable' => [
        'accessories'  => ':count Recurso educativo e brinquedo™️count Recursos Educativos e Brinquedos',
        'asset'  => ':count Utente',
        'licenses'  => ':count Inscrições,:count Inscrições',
        'license_seats'  => ':count inscrição assentonamed@@0:count inscrição de assentos',
        'consumables'  => ':count Material de consumo|:count Materiais de Consumo',
        'components'  => ':count Componente|:count Componentes',
    ],
    'more_info' => 'Mais Informações',
    'quickscan_bulk_help' => 'Checking this box will edit the utente record to reflect this new location. Leaving it unchecked will simply note the location in the audit log. Note that if this utente is checked out, it will not change the location of the person, utente or location it is checked out to.',
    'whoops' => 'Whoops!',
