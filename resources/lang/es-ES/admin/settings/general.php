...
'ldap_location_help'             => 'El campo Location (ubicación) de Ldap debe utilizarse si <strong>una OU no está siendo utilizada en el Base Bind DN (DN del enlace base).</strong> Deje este espacio en blanco si se utiliza una búsqueda OU.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Si se proporciona una url aquí, los usuarios serán redirigidos a esta URL después de que el usuario cierre la sesión de Parque Seguro. Esto es útil para cerrar correctamente las sesiones de usuario de su proveedor de autenticación.',
    ...
    'support_footer_help'       => 'Especifica quien ve los enlaces de información de Soporte y Manual de Usuarios de Parque Seguro',
    'version_footer'            => 'Versión en el pie de página ',
    'version_footer_help'       => 'Especifica quién ve la versión y el número de compilación de Parque Seguro.',
