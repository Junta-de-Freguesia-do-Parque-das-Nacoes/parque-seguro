...
'ldap_location_help'             => 'Feltet Ldap Location skal anvendes, hvis <strong>en OU ikke anvendes i Base Bind DN.</strong> Efterlad dette tomt hvis en OU søgning bruges.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Hvis en URL er angivet her, vil brugere blive omstillet til den efter de har logget ud af Parque Seguro. Det er anvendeligt for at lukke bruger sessions i din authentiseringsmekanisme korrekt.',
    ...
    'show_images_in_email_help'   => 'Afkryds denne boks hvis din Parque Seguro installation er bag en VPN eller i et lukket netværk og brugere udenfor netværket vil forhinderes i at anvende billeder fra netværket i deres emails.',
    'site_name'                 => 'Side navn',
    ...
    'support_footer_help'       => 'Angiv hvem der kan se links i Parque Seguro Support info og brugermanual',
    'version_footer'            => 'Version in footer ',
    'version_footer_help'       => 'Angiv hvem der kan se Parque Seguro versions- og buildnummer.',
    ...
    'width_w'        => 'w',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Link til Parque Seguro i e-mails',
    'show_url_in_emails_help_text'      => 'Fjern markeringen i dette felt, hvis du ikke vil linke tilbage til din Parque Seguro-installation i dine e-mail-fodbold. Nyttigt, hvis de fleste af dine brugere aldrig logger ind.',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'Dette vil forsøge at slette cachede stregkoder. Dette vil typisk kun blive brugt, hvis dine stregkodeindstillinger er ændret, eller hvis din Parque Seguro-URL er ændret. Stregkoder vil blive gengenereret når tilgås næste.',
    ...
    'help_default_will_use' => '<code>:default</code> vil bruge værdien fra <code>:setting_name</code>. <br>Bemærk, at værdien af stregkoderne skal overholde den respektive stregkode spec for at blive genereret med succes. Se venligst <a href="https://Parque Seguro.readme.io/docs/barcodes">dokumentationen <i class="fa fa-external-link"></i></a> for flere detaljer. ',
    'default'               => 'Standard',
    'none'                  => 'Ingen',
