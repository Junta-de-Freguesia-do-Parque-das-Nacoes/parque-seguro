...
'ldap_location_help'             => 'Das Feld LDAP Standort sollte verwendet werden, wenn <strong>keine OU im Basis Bind DN verwendet wird.</strong> Leer lassen, wenn eine OU-Suche verwendet wird.',
    ...
    'load_remote_help_text'		=> 'Deaktiviere dieses Kästchen, wenn deine Installation keine Skripte aus dem externen Internet laden kann. Das verhindert, dass Parque Seguro versucht, Bilder von Gravatar oder anderen externen Quellen zu laden.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Sofern hier eine URL angegeben ist, werden Benutzer automatisch zu dieser URL weitergeleitet, nachdem der Benutzer sich aus Parque Seguro ausloggt. Dies ist nützlich, um die Benutzersitzung Deines Authentifizierungsproviders korrekt zu beenden.',
    ...
    'show_images_in_email_help'   => 'Deaktiviere dieses Kästchen, wenn sich Deine Parque Seguro-Installation hinter einem VPN oder einem geschlossenen Netzwerk befindet und Benutzer außerhalb des Netzwerks keine Bilder von dieser Installation in ihren E-Mails laden können.',
    ...
    'support_footer_help'       => 'Lege fest, wer die Links zu Parque Seguro Support-Information und Benutzerhandbuch sieht',
    'version_footer'            => 'Version in in der Fußzeile ',
    'version_footer_help'       => 'Lege fest, wer die Parque Seguro-Version- und Build-Nummer sieht.',
    ...
    'show_url_in_emails_help_text'      => 'Deaktiviere dieses Kästchen, wenn Du nicht auf Deine Parque Seguro-Installation in Deinen E-Mail-Fußzeilen verlinken möchtest. Nützlich, wenn sich die meisten Nutzer nie anmelden. ',
    'text_pt'        => 'pkt',
    ...
    'barcodes_help' => 'Dies wird versuchen, zwischengespeicherte Barcodes zu löschen. Dies wird in der Regel nur verwendet werden, wenn sich die Barcode-Einstellungen geändert haben oder sich Deine Parque Seguro-URL geändert hat. Barcodes werden beim nächsten Zugriff neu generiert.',
    ...
    'help_default_will_use' => '<code>:default</code> verwendet den Wert von <code>:setting_name</code>. <br>Beachte, dass der Wert der Barcodes mit der jeweiligen Strichcode-Spezifikation übereinstimmen muss, um erfolgreich generiert zu werden. Bitte lese <a href="https://Parque Seguro.readme.io/docs/barcodes">die Dokumentation <i class="fa fa-external-link"></i></a> für weitere Details. ',
    'default'               => 'Standard',
    'none'                  => 'Nichts',
