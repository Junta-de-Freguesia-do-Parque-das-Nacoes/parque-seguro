...
'ldap_location_help'             => 'Le champ "LDAP Localisation" ne doit être utilisé que si <strong>aucune OU n\'est définie dans le champ Bind de base DN</strong>. Laissez vide si une recherche par OU est utilisée.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Si une URL est spécifiée ici, les utilisateurs seront redirigés vers cette URL après la déconnexion de Parque Seguro. Ceci est utile pour fermer correctement les sessions utilisateur de votre fournisseur d\'authentification.',
    ...
    'show_images_in_email_help'   => 'Décocher cette case si votre installation de Parque Seguro est derrière un VPN ou un réseau fermé et que les utilisateurs en dehors du réseau ne peuvent pas charger les images servies depuis cette installation dans leurs courriels.',
    ...
    'support_footer_help'       => 'Spécifiez qui voit les liens vers les manuels de support utilisateur Parque Seguro',
    'version_footer'            => 'Version en pied de page ',
    'version_footer_help'       => 'Spécifiez qui peut voir la version de Parque Seguro.',
    ...
    'width_w'        => 'l',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Lien vers Parque Seguro dans les e-mails',
    'show_url_in_emails_help_text'      => 'Décochez cette case si vous ne souhaitez pas relier votre installation Parque Seguro à vos pieds de page. Utile si la plupart de vos utilisateurs ne se connectent jamais.',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'Cette opération essaiera de supprimer l\'ensemble des code-barres mis en cache. Cette opération n\'est utile que si les réglages de génération de code-barre ont été changés, ou si l\'URL de votre instance Parque Seguro a été modifiée. Les code-barres seront regénérés au prochain accès.',
