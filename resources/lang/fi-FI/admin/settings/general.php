...
'ldap_location_help'             => 'Ldap Location -kenttää tulee käyttää, jos tukikohdan Bind-nimisessä nimessä ei käytetä <strong>-yksikköä.</strong> Jätä tämä tyhjäksi, jos hakua käytetään.',
    ...
    'show_images_in_email_help'   => 'Poista tämä valinta, jos Parque Seguro asennus on toteutettu VPN: n avulla tai suljetussa verkossa, koska sähköposteissa käytetyt kuvat eivät voi latautua näkyviin sähköposteissa.',
    ...
    'snipe_version'  			=> 'Parque Seguro versio',
    'support_footer'            => 'Tuki-alatunnisteen linkit ',
    'support_footer_help'       => 'Määrittele, kuka voi nähdä linkit Parque Seguro tukipalvelun tietoihin ja käyttöohjeeseen',
    'version_footer'            => 'Versio alatunnisteessa ',
    'version_footer_help'       => 'Määrittele, kuka näkee Parque Seguro järjestelmän version ja käännöksen numeron.',
    ...
    'width_w'        => 'l',
    'height_h'        => 'k',
    'show_url_in_emails'                => 'Linkki Parque Seguro: hen sähköposteissa',
    'show_url_in_emails_help_text'      => 'Poista tämä valintaruutu, jos et halua linkata takaisin Parque Seguro-asennukseen sähköpostin alatunnisteisiin. Hyödyllinen, jos useimmat käyttäjät eivät koskaan kirjaudu sisään.',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'Tämä yrittää poistaa välimuistissa olevat viivakoodit. Tätä käytetään yleensä vain, jos viivakoodisi asetukset ovat muuttuneet, tai jos Parque Seguro URL on muuttunut. Viivakoodit luodaan uudelleen, kun niitä käytetään seuraavaksi.',
