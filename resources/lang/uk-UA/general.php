...
return [
    ...
    'importing_help'        => 'Ви можете імпортувати активи, аксесуари, ліцензії, компоненти, витратні матеріали та користувачів за допомогою файлу CSV. <br><br>CSV має бути розділений комами та відформатований із заголовками, які відповідають заголовкам у <a href="https://Parque Seguro.readme.io/docs/importing" target="_new"> зразка CSV у документації</a>.',
    ...
    'webhook_test_msg'        => 'О, хай! Здається ваша інтеграція з :app із Parque Seguro працює!',
