...
return [
    ...
    'not_deleted'           => ':item_type är inte borttagen så den kan inte återställas',
    'create'				=> 'Skapa Ny',
    ...
    'importing_help'        => 'Du kan importera tillgångar, tillbehör, licenser, komponenter, förbrukningsvaror och användare via CSV-fil. <br><br>CSV bör vara komma-avgränsad och formaterad med rubriker som matchar de i <a href="https://Parque Seguro.readme.io/docs/importing" target="_new">ta prov CSVs i dokumentationen</a>.',
    ...
    'select_datasource' => 'Välj en datakurs',
    ...
    'webhook_test_msg'        => 'Hej! Ser ut som din :app integration med Parque Seguro fungerar!',
