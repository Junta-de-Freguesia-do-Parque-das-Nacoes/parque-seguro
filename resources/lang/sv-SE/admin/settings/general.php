...
'ldap_location_help'             => 'LDAP platsfältet bör användas om <strong>ett OU inte används i Base Bind DN.</strong> Lämna detta tomt om en OU-sökning används.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Om en URL tillhandahålls här kommer användarna att omdirigeras till den här webbadressen efter att användaren loggat ut från Parque Seguro. Det här är användbart för att stänga användarsessionerna i din autentiseringsleverantör korrekt.',
    ...
    'show_images_in_email_help'   => 'Avmarkera den här rutan om din Parque Seguro-installation ligger bakom ett VPN eller ett stängt nätverk och användare utanför nätverket kan inte ladda bilder som visas från den här installationen i sina e-postmeddelanden.',
    'site_name'                 => 'Sidnamn',
    ...
    'snipe_version'  			=> 'Parque Seguro-versionen',
    'support_footer'            => 'Stöd länkar i sidfot ',
    'support_footer_help'       => 'Ange vem som kan se länkarna till Parque Seguro Support info och användarmanual',
    'version_footer'            => 'Version i sidfot ',
    'version_footer_help'       => 'Specificera vilka som kan se Parque Seguro version och build nummer.',
    ...
    'width_w'        => 'w',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Länk till Parque Seguro i e-post',
    'show_url_in_emails_help_text'      => 'Avmarkera den här rutan om du inte vill länka tillbaka till din Parque Seguro-installation i dina e-postfoton. Användbart om de flesta av dina användare aldrig loggar in.',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'Detta kommer att försöka ta bort cachade streckkoder. Detta skulle normalt bara användas om dina streckkodsinställningar har ändrats, eller om din Parque Seguro-URL har ändrats. Streckkoder kommer att återskapas när de nås härnäst.',
    ...
    'help_default_will_use' => '<code>:default</code> kommer att använda värdet från <code>:setting_name</code>. <br>Observera att värdet på streckkoderna måste följa respektive streckkodspec för att framgångsrikt kunna genereras. Se <a href="https://Parque Seguro.readme.io/docs/barcodes">dokumentationen <i class="fa fa-external-link"></i></a> för mer information. ',
    'default'               => 'Standard',
    'none'                  => 'Inga',
