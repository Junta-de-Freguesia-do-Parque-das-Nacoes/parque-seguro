...
'ldap_location_help'             => 'يجب استخدام حقل موقع Ldap إذا لم يتم استخدام <strong>OU في قاعدة ربط DN.</strong> اتركه فارغاً إذا تم استخدام بحث OU',
    ...
    'login_remote_user_custom_logout_url_help' => 'إذا تم توفير عنوان URL هنا، سيتم إعادة توجيه المستخدمين إلى عنوان URL هذا بعد تسجيل خروج المستخدم من Parque Seguro. هذا مفيد لإغلاق جلسات عمل المستخدم لموفر المصادقة بشكل صحيح.',
    ...
    'show_images_in_email_help'   => 'قم بإلغاء تحديد هذا المربع إذا كان تثبيت Parque Seguro وراء شبكة VPN أو شبكة مغلقة ولن يتمكن المستخدمون خارج الشبكة من تحميل الصور التي يخدمها هذا التثبيت في رسائل البريد الإلكتروني الخاصة بهم.',
    ...
    'version_footer_help'       => 'حدد من سوف يرى إصدار Parque Seguro و رقم النسخة.',
    ...
    'width_w'        => 'ث',
    'height_h'        => 'ح',
    'show_url_in_emails'                => 'الرابط إلى Parque Seguro في رسائل البريد الإلكتروني',
    'show_url_in_emails_help_text'      => 'قم بإلغاء اختيار هذا المربع إذا كنت لا ترغب في الربط مرة أخرى إلى Parque Seguro في تذييل البريد الإلكتروني الخاص بك. تعد مفيدة إذا كان معظم المستخدمين لا يقومون بتسجيل الدخول. ',
    'text_pt'        => 'حزب العمال',
    ...
    'barcodes_help' => 'هذا سيحاول حذف رموز الباركود المخزنة مؤقتاً. سيتم استخدام هذا عادة فقط إذا تغيرت إعدادات الباركود الخاص بك، أو إذا تغير رابط Parque Seguro الخاص بك. سيتم إعادة إنشاء الرموز الشريطية عند الوصول إليها بعد ذلك.',
