...
return [
    ...
    'importing'         	=> 'الاستيراد',
    'importing_help'        => 'يمكنك استيراد الأصول، الملحقات، التراخيص، المكونات، المواد الاستهلاكية، والمستخدمين عبر ملف CSV. <br><br>يجب أن تكون CSV محددة بفواصل وأن يتم تنسيقها مع رؤوس تطابق تلك الموجودة في <a href="https://Parque Seguro.readme.io/docs/importing" target="_new">عينة CSVs في الوثائق</a>.',
    ...
    'webhook_test_msg'        => 'مرحباً! يبدو أن تكامل :app مع Parque Seguro يعمل!',
