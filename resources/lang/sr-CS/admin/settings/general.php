...
'ldap_location_help'             => 'LDAP Lokacija polje treba koristiti ukoliko <strong>se ne koristi OU u Korenski DN za pretragu.</strong> Ostavite polje prazno ukoliko se OU koristi za pretragu.',
    ...
    'load_remote_help_text'		=> 'Isključi ovo polje ako tvoja instalacija ne može da učita skripte sa spoljnog interneta. Ovo će sprečiti Parque Seguro od pokušaja da učita slike sa Gravatara ili drugih spoljnih izvora.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Ako se ovde navede url, korisnici će biti preusmereni na ovu URL adresu nakon što se korisnik odjavi sa Parque Seguro-a. Ovo je korisno za pravilno zatvaranje korisničkih sesija vašeg dobavljača autentikacije.',
    ...
    'show_images_in_email_help'   => 'Poništite izbor u ovom polju za potvrdu ako je vaša Parque Seguro instalacija iza VPN-a ili zatvorene mreže i korisnici van mreže neće moći da učitavaju slike koje se serviraju iz ove instalacije u svoje imejlove.',
    ...
    'support_footer_help'       => 'Navedite ko vidi veze do informacija o podršci za Parque Seguro i korisničkog priručnika',
    'version_footer'            => 'Verzija u podnožju ',
    'version_footer_help'       => 'Navedite ko vidi verziju Parque Seguro-a i broj verzije.',
    ...
    'width_w'        => 'š',
    'height_h'        => 'v',
    'show_url_in_emails'                => 'Link ka Parque Seguro in emailovima',
    'show_url_in_emails_help_text'      => 'Poništite izbor u ovom polju za potvrdu ako ne želite da se vratite na svoju Parque Seguro instalaciju u podnožju e-pošte. Korisno ako se većina vaših korisnika nikada ne prijavi. ',
    'text_pt'        => 'pt',
