...
'ldap_location_help'             => 'The Ldap Location field should be used if <strong>an OU is not being used in the Base Bind DN.</strong> Leave this blank if an OU search is being used.',
    ...
    'login_remote_user_custom_logout_url_help' => 'If a url is provided here, users will be redirected to this URL after the user logs out of Parque Seguro. This is useful to close the user sessions of your Authentication provider correctly.',
    ...
    'version_footer_help'       => 'Specify who can see the Parque Seguro version and build number.',
    ...
    'width_w'        => 'w',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Link to Parque Seguro in Emails',
    'show_url_in_emails_help_text'      => 'Uncheck this box if you do not wish to link back to your Parque Seguro installation in your email footers. Useful if most of your users never login. ',
    'text_pt'        => 'pt',
