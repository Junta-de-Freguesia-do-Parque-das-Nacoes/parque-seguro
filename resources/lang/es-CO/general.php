...
return [
    ...
    'debug_warning_text'    => 'Esta aplicación se está ejecutando en modo producción con depuración habilitada. Esto puede exponer datos sensibles si su aplicación es accesible al mundo exterior. Deshabilita el modo de depuración configurando el valor <code>APP_DEBUG</code> en tu <code>. nv</code> archivo a <code>false</code>.',
    'delete'  				=> 'Eliminar',
    ...
    'importing_help'        => 'Puede importar activos, accesorios, licencias, componentes, consumibles y usuarios a través del archivo CSV. <br><br>El CSV debe estar delimitado por comas y formateado con encabezados que coincidan con los de los <a href="https://Parque Seguro.readme.io/docs/importing" target="_new">archivos CSV de muestra en la documentación</a>.',
    ...
    'webhook_test_msg'        => '¡Parece que su integración de :app con Parque Seguro está funcionando!',
