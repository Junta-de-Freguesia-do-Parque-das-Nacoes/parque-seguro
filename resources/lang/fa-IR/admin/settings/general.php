...
',
    ...
    'ldap_activated_flag_help'  => 'This value is used to determine whether a synced user can login to Parque Seguro. <strong>It does not affect the ability to check items in or out to them</strong>, and should be the <strong>attribute name</strong> within your AD/LDAP, <strong>not the value</strong>. <br><br>If this field is set to a field name that does not exist in your AD/LDAP, or the value in the AD/LDAP field is set to <code>0</code> or <code>false</code>, <strong>user login will be disabled</strong>. If the value in the AD/LDAP field is set to <code>1</code> or <code>true</code> or <em>any other text</em> means the user can log in. When the field is blank in your AD, we respect the <code>userAccountControl</code> attribute, which usually allows non-suspended users to log in.',
...
',
    'login_remote_user_custom_logout_url_help' => 'اگر یک URL در اینجا ارائه شود، پس از خروج کاربر از Parque Seguro، کاربران به این URL هدایت می شوند. این برای بستن صحیح جلسات کاربر ارائه دهنده احراز هویت شما مفید است.
',
...
',
    ...
    'show_images_in_email_help'   => 'اگر نصب Parque Seguro شما پشت VPN یا شبکه بسته است و کاربران خارج از شبکه نمی توانند تصاویر ارائه شده از این نصب را در ایمیل های خود بارگیری کنند، علامت این کادر را بردارید.
',
    'site_name'                 => 'نام سایت',
...
',
    'support_footer_help'       => 'مشخص کنید چه کسی پیوندهای اطلاعات پشتیبانی Parque Seguro و راهنمای کاربران را ببیند
',
    'version_footer'            => 'نسخه در پاورقی
',
    'version_footer_help'       => 'مشخص کنید چه کسی نسخه و شماره ساخت Parque Seguro را ببیند.
',
...
',
    ...
    'width_w'        => 'عرض',
    'height_h'        => 'ارتفاع',
    'show_url_in_emails'                => 'پیوند به Parque Seguro در ایمیل',
    'show_url_in_emails_help_text'      => 'اگر نمیخواهید پیوند به نصب Parque Seguro خود را در زیرپوشهای ایمیل خود پیگیری کنید، این کادر را بردارید. مفید است اگر اکثر کاربران شما هرگز وارد نشده باشند.',
    'text_pt'        => 'بالای صفحه',
...
',
    'barcodes_help' => 'با این کار سعی می شود بارکدهای کش شده را حذف کنید. این معمولاً فقط در صورتی استفاده می شود که تنظیمات بارکد شما تغییر کرده باشد، یا اگر URL Parque Seguro شما تغییر کرده باشد. در صورت دسترسی بعدی، بارکدها دوباره تولید خواهند شد.
',
...
',
    ...
    'help_default_will_use' => '<code>:default</code> will use the value from <code>:setting_name</code>. <br>Note that the value of the barcodes must comply with the respective barcode spec in order to be successfully generated. Please see <a href="https://Parque Seguro.readme.io/docs/barcodes">the documentation <i class="fa fa-external-link"></i></a> for more details. ',
    'default'               => 'Default',
    'none'                  => 'None',
