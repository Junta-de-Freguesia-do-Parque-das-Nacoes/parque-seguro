...
return [
    ...
    'login' => 'Вход:',
    'login_first_admin' => 'Влезте в своята Parque Seguro инсталация използвайки данните по-долу:',
    ...
    'snipe_webhook_test' => 'Parque Seguro Интеграционен тест',
    'snipe_webhook_summary' => 'Parque Seguro Резюме на интеграционния тест',
    'supplier' => 'Доставчик',
    'tag' => 'Етикет',
    'test_email' => 'Тест Email от Parque Seguro',
    'test_mail_text' => 'Това е тест от Parque Seguro система за управление на активи. Ако сте получили това, email-а работи :)',
    ...
    'your_credentials' => 'Вашите идентификационни данни за Parque Seguro',
