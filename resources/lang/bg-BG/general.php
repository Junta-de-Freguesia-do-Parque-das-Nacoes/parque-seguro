...
return [
    ...
    'importing_help'        => 'Може да импортирате активи, аксесоари, лицензи, компоненти, консумативи и потребители чрез CSV файл. <br><br>CSV файла трябва да е разделен със запетая и форматирани колони, като тези от <a href="https://Parque Seguro.readme.io/docs/importing" target="_new">примерен CSV файл</a>.',
    ...
    'webhook_test_msg'        => 'Интеграцията на вашето :app пролежение работи с Parque Seguro!',
