...
'ldap_location_help'             => 'O campo de Localização do dap deve ser usado se <strong>um OU não estiver sendo usado no DNS de vinculação base.</strong> Deixe em branco se uma busca OU estiver sendo usada.',
    ...
    'load_remote_help_text'		=> 'Desmarque essa caixa se a sua instalação não pode carregar scripts vindos da internet. Isso vai prevenir que o Parque Seguro carregue avatares do Gravatar ou outras fontes externas.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Se uma URL for inserida aqui, os usuários serão redirecionados para a essa URL após desconectarem do Parque Seguro. Isso pode ser útil para encerrar sessões com o seu provedor de Autenticação corretamente.',
    ...
    'show_images_in_email_help'   => 'Desmarque esta caixa se sua instalação de Parque Seguro está por trás de uma VPN ou rede fechada e usuários fora da rede não será capazes de carregar imagens, servidas a partir desta instalação em seus e-mails.',
    ...
    'snipe_version'  			=> 'Versão do Parque Seguro',
    'support_footer'            => 'Links de rodapé de suporte ',
    'support_footer_help'       => 'Especifique quem vê os links para as informações de Suporte Parque Seguro e o Manual do Usuário',
    ...
    'show_url_in_emails_help_text'      => 'Desmarque esta caixa se não deseja vincular novamente a sua instalação Parque Seguro em seus rodapés de e-mail. Útil se a maioria de seus usuários nunca logar. ',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'Isto tentará apagar códigos de barras em cache. Isso normalmente só seria usado se as configurações do código de barras tivessem sido alteradas, ou se a URL do Parque Seguro tivesse sido alterada. Códigos de barras serão re-gerados quando acessados em seguida.',
