                ...
                <table
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="col-sm-1" data-field="type" data-visible="false" data-formatter="itemTypeFormatter">{{ trans('general.type') }}</th>
                            <th class="col-sm-3" data-field="item.serial" data-visible="false">{{ trans('admin/hardware/table.serial') }}</th>
                            <th class="col-sm-3" data-field="item" data-formatter="polymorphicItemFormatter">{{ trans('general.item') }}</th>
                            <th class="col-sm-2" data-field="target" data-visible="false" data-formatter="polymorphicItemFormatter">{{ trans('general.to') }}</th>
                            ...
                            <th class="col-sm-2" data-field="action_source_label" data-escape="false">{{ trans('general.action_source') }}</th>
