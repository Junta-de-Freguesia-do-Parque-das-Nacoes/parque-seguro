              ...
              <table class="display table table-hover">
                <thead>
                  <tr>
                    ...
                    <th class="text-right">
                      <i class="fas fa-children fa-fw" aria-hidden="true" style="font-size: 17px;"></i>
                      <span class="sr-only">{{ trans('general.assets') }}</span>
                    </th>
                    <th class="text-right">
                      <i class="fas fa-puzzle-piece" aria-hidden="true" style="font-size: 17px;"></i>
                      <span class="sr-only">{{ trans('general.accessories') }}</span>
                    </th>
                    <th class="text-right">
                      <i class="fas fa-scroll" aria-hidden="true" style="font-size: 17px;"></i>
                      <span class="sr-only">{{ trans('general.licenses') }}</span>
                    </th>
                    <th class="text-right">
                      <i class="fas fa-box fa-fw" aria-hidden="true" style="font-size: 17px;"></i>
