...
<img src="data:image/png;base64, {{ config('app.url') }}/confirmar-check/{{ $asset->id }}" alt="QR code for {{ $asset->name }}"> -->
<img src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(150)->generate('https://parque-seguro.jf-parquedasnacoes.pt:8126/confirmar-check/' . $asset->id)) !!}" alt="QR code for {{ $asset->name }}">
