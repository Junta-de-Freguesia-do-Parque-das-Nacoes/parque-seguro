...
<div class="form-group {{ $errors->has('email_format') ? 'error' : '' }}">
    ...
    <div class="col-md-9">
        {{ Form::select('email_format', 
            ['email' => 'Email', 'username' => 'Nome de Utilizador'], 
            old('email_format', $setting->email_format), 
            ['class' => 'form-control']
        ) }}
...
<div class="form-group {{ $errors->has('username_format') ? 'error' : '' }}">
    ...
    <div class="col-md-9">
        {{ Form::select('username_format', 
            ['email' => 'Email', 'username' => 'Nome de Utilizador'], 
            old('username_format', $setting->username_format), 
            ['class' => 'form-control']
        ) }}
