        ...
        <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
            ...
            <div class="panel box box-default">
                ...
                <div class="box-body">
                    ...
                    <select name="two_factor_enabled" class="form-control select2">
    <option value="" {{ old('two_factor_enabled', $setting->two_factor_enabled) == '' ? 'selected' : '' }}>
        {{ trans('admin/settings/general.two_factor_disabled') }}
    </option>
    <option value="1" {{ old('two_factor_enabled', $setting->two_factor_enabled) == '1' ? 'selected' : '' }}>
        {{ trans('admin/settings/general.two_factor_optional') }}
    </option>
    <option value="2" {{ old('two_factor_enabled', $setting->two_factor_enabled) == '2' ? 'selected' : '' }}>
        {{ trans('admin/settings/general.two_factor_required') }}
    </option>
</select>
