        ...
        <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
            ...
            <div class="panel box box-default">
                <div class="box-header with-border">
                    <h2 class="box-title">
                        <i class="fas fa-children" aria-hidden="true"></i> {{ trans('admin/settings/general.barcodes') }}
                    </h2>
                </div>
                <div class="box-body">
...
<div class="form-group{{ $errors->has('barcode_type') ? ' has-error' : '' }}">
    ...
    <div class="col-md-9">
        {{ Form::select('barcode_type', [
            ...
            'ean13' => 'EAN 13',
            'ean8' => 'EAN 8'
        ], old('barcode_type', $setting->barcode_type), ['class' => 'form-control']) }}
...
<div class="form-group{{ $errors->has('alt_barcode') ? ' has-error' : '' }}">
    ...
    <div class="col-md-9">
        {{ Form::select('alt_barcode', [
            'code128' => 'Code 128',
            'code39' => 'Code 39',
            'ean13' => 'EAN 13',
            'ean8' => 'EAN 8'
        ], old('alt_barcode', $setting->alt_barcode), ['class' => 'form-control']) }}
        {!! $errors->first('alt_barcode', '<span class="alert-msg" aria-hidden="true"><i class="fas fa-times" aria-hidden="true"></i> :message</span>') !!}
    </div>
</div>
                        @else
