                ...
                <div class="box-body">
                        ...
                        <div class="form-group {{ $errors->has('site_name') ? 'error' : '' }}">
                            ...
                            <div class="col-md-7 required">
                                @if (config('app.lock_passwords')===true)
                                    {{ Form::text('site_name', old('site_name', $setting->site_name), array('class' => 'form-control', 'disabled'=>'disabled','placeholder' => 'Parque Seguro Asset Management')) }}
                                    <p class="text-warning"><i class="fas fa-lock"></i> {{ trans('general.feature_disabled') }}</p>
                                @else
                                    {{ Form::text('site_name',
                                        old('site_name', $setting->site_name), array('class' => 'form-control','placeholder' => 'Parque Seguro Asset Management', 'required' => 'required')) }}
                                @endif
                    ...
                    @include('partials/forms/edit/uploadLogo', [
                        ...
                        <div class="form-group {{ $errors->has('skin') ? 'error' : '' }}">
                            ...
                            <div class="col-md-9">
                                {!! Form::skin('skin', old('skin', $setting->skin), ['class' => 'form-control select2']) !!}
