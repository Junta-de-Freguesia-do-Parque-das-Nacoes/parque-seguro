/* 
 * 
 * Parque Seguro Universal Modal support
 * 
 * Enables modal dialogs to create sub-resources throughout Parque Seguro
 * 
 */
...
function formatDatalistSafe(datalist) {
    ...
    if (datalist.image) {
         ...
         * in Parque Seguro. If that changes, we would probably want to change
