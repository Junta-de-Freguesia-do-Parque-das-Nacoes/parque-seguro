...
mix
  ...
  // LINHA ALTERADA: admin-lte não usa mais less na pasta build/less.
  // Importa o CSS minificado do AdminLTE diretamente da pasta 'dist'.
  .styles("./node_modules/admin-lte/dist/css/adminlte.min.css", "public/css/build/AdminLTE.css")
  ...
  .styles(
    [
      ...
      // Este ficheiro já está a ser gerado acima pela nova linha .styles() do AdminLTE
...
mix
  .js(
    [
      "./resources/assets/js/snipeit.js", //this is the actual Parque Seguro JS - require()s bootstrap.js
...
mix.combine(
  [
    ...
    // Esta linha já aponta para o caminho correto do AdminLTE, o que é bom
