...
return [
    ...
    */
    ...
    'guards' => [
        ...
        'ee' => [
            'driver' => 'session',
            'provider' => 'responsavels', // Este nome DEVE corresponder ao 'provider' que vamos definir abaixo
        ],
    ...
    */
    ...
    'providers' => [
        ...
        'responsavels' => [
            'driver' => 'eloquent',
            'model' => App\Models\Responsavel::class, // O caminho COMPLETO para o teu modelo Responsavel
        ],
