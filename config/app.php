...
return [
    ...
    */
    ...
    'name' => env('SITE_NAME', 'PARQUE SEGURO'),
    ...
    */
    ...
    'url' =>  env('APP_URL', 'https://parque-seguro.jf-parquedasnacoes.pt:8126'),
   ...
   | Parque Seguro within an I-Frame, which is normally disabled by default for
   ...
   */
    ...
    */
    ...
    | version of Parque Seguro with limited functionality to prevent demo abuse.
    |
    */
